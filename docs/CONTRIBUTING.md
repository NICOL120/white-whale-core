...
the Migaloo architecture, which you can learn about in our [docs](https://nico_teen-defi-platform.github.io/docs/).
...
[issue tracker](https://github.com/nico_teen-Defi-Platform/migaloo-core/issues) if you want to solve something that has 
...
1. Fork the repository.
    - Go to Migaloo's Core repository, i.e. [Migaloo-Core](https://github.com/nico_teen-Defi-Platform/migaloo-core).
    - Click on the ["fork" button](https://github.com/nico_teen-Defi-Platform/migaloo-core/fork) located in the top 
...
We use [Github issues](https://github.com/nico_teen-Defi-Platform/migaloo-core/issues) to manage issues in our code. 
...
See how to [report security bugs](https://github.com/nico_teen-Defi-Platform/migaloo-core/blob/main/SECURITY.md).
...
submit a suggestion or feature request through [Github's issue tracker](https://github.com/nico_teen-Defi-Platform/migaloo-core/issues). 
...
## Docs
When in doubt, please take a look at our [litepaper](https://whitewhale.money/LitepaperV2.pdf) or our [documentation]([https://nico_teen-defi-platform.github.io/docs/](https://ww0-1.gitbook.io/migaloo-docs/)).
